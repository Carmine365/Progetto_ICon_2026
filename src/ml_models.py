...
# IMPORT CORRETTO: Assicurati che la classe in water_data.py si chiami 'water_data'
...
class water_model:
    ...
    def __init__(self, model, x, y, scores_dict: dict, test_size: float):
        ...
        # FONDAMENTALE: Il nome della colonna target nel CSV dell'acqua
...
class water_logistic_regression(water_model):

    def __init__(self, data: water_data, iterations: int, test_size: float):
        ...
        water_model.__init__(self, LogisticRegression(
...
class water_decision_tree(water_model):

    def __init__(self, data: water_data, max_d: int, test_size: float):
        ...
        water_model.__init__(self, tree.DecisionTreeClassifier(
...
class water_knn(water_model):
    ...
    def __init__(self, data: water_data, test_size: float, neighbors: int):
        ...
        water_model.__init__(self, KNeighborsClassifier(
